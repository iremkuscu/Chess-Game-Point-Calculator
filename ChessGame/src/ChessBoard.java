...
public class ChessBoard {
	...
	public static String[][] TextFileReader(String fileName) throws FileNotFoundException { // method to read text file and generate an 8x8 chess board in a String format
	...
	public static boardSpot[][] fillChessPieceArray(String fileName) throws FileNotFoundException { // method to read text file and generate an 8x8 chess board filled with chessPiece objects
		File boardTextFile = new File(fileName);
		Scanner myReader = new Scanner(boardTextFile);
		int lineCount=0;
		while (myReader.hasNextLine()) {
	...
	public static boolean inBounds(int row, int column) { // method to check if a boardSpot is inside the 8x8 chess board
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("The black team's point is " + pointCalculation.pointCalculator("black"));
		System.out.println("The white team's point is " + pointCalculation.pointCalculator("white"));
	}
